...
class Kelas_m extends CI_Model
{
	...
	var $table = 'tbkelas'; //nama tabel dari database
	var $column_order = array(null, 'id_kelas', 'kelas'); //field yang ada di table user
	var $column_search = array('kelas'); //field yang diizin untuk pencarian 
	...
	public function get_data($kelas)
	{
