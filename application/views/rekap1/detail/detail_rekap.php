        ...
        <div class="col-md-6">
            <div class="box box-info">
                ...
                <div class="box-body">
                    <form action="#" method="post">
                        <?php foreach ($tampil as $row) : ?>
                            ...
                            <div class="form-group">
                                <label>Dari</label>
                                <input type="date" name="dari" class="form-control" autocomplete="off" value="<?= $row['tgl1'] ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label>Sampai</label>
                                <input type="date" name="sampai" class="form-control" autocomplete="off" value="<?= $row['tgl2'] ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label>Mulai</label>
                ...
                <div class="box-footer clearfix">
                    <a href="<?= base_url('rekap1'); ?>" class="btn btn-default pull-right">Kembali</a>
                </div>
                </form>
            </div>
            <!-- /.box -->
