    ...
    <div class="row">
        <div class="col-md-6">
            <div class="box box-info">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form action="<?= base_url('pengajuan_admin2/simpan_ormawa'); ?>" method="post">
                ...
                <div class="box-footer clearfix">
                    ...
                    <a href="<?= base_url('pengajuan_admin2'); ?>" class="btn btn-default">Kembali</a>
                </div>
                </form>
            </div>
            <!-- /.box -->
