                        ...
                        <tbody>
                            ...
                            foreach ($tampil as $row) { ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- detail admin1 -->
                                        <a href="<?= base_url('rekap2/detail_rekap/') . encrypt_url($row['id_rekap']); ?>" class="btn btn-info btn-sm"> <i class="fa fa-eye"></i> </a>
                                        <!-- end detail admin1 -->

                                        <!-- print rekap admin1 admin -->
                                        <!-- <a href="<?= base_url('rekap2/print_rekap_ormawa2/') . encrypt_url($row['id_rekap']); ?>" class="btn btn-primary btn-sm" target="_blank"> <i class="fa fa-print"></i> </a> -->

                                        <a href="<?= base_url('rekap2/print_rekap2/') . encrypt_url($row['id_rekap']); ?>" class="btn btn-primary btn-sm" target="_blank"> <i class="fa fa-print"></i> </a>


                                        <!-- end print rekap admin1 admin -->

                                        <a href="<?= base_url('rekap2/hapus/') . encrypt_url($row['id_rekap']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin?');"> <i class="fa fa-trash-o"></i></a>
                                    </td>
...
<div class="modal fade" id="modal-default">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('rekap2/print_periode2') ?>" method="post" target="_blank">
...
<script>
    $(function() {
        $("#tabel2").DataTable({
            ...
            "ajax": {
                "url": "<?= base_url('rekap2/get_rekap2') ?>",
                "type": "POST"
            },
