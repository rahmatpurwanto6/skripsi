        ...
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    <!-- mahasiswa -->
                    <a href="<?= base_url('pengajuan_kemhs/tambah'); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Pengajuan untuk kemahasiswaan</a>
                    <!-- end mahasiswa -->
                </div>
                <!-- /.box-header -->
...
<script>
    ...
    function load_data() {
        $("#tabel3").DataTable({
            ...
            "ajax": {
                "url": "<?= base_url('pengajuan_kemhs/get_datakemhs') ?>",
                "type": "POST"
            },
