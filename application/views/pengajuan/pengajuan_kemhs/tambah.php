    ...
    <div class="row">
        <div class="col-md-6">
            <div class="box box-info">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form action="<?= base_url('pengajuan_kemhs/simpan'); ?>" method="post">
                ...
                <div class="box-footer clearfix">
                    <button type="submit" id="pengajuan" class="btn btn-primary"><i class="fa fa-paper-plane"></i> Simpan</button>
                    <a href="<?= base_url('pengajuan_kemhs'); ?>" class="btn btn-default">Kembali</a>
                </div>
                </form>
            </div>
            <!-- /.box -->
