        ...
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    <!-- mahasiswa -->
                    <a href="<?= base_url('pengajuan_mhs/tambah'); ?>" class="btn btn-primary" style="margin-top: 2px;"><i class="fa fa-plus"></i> Pengajuan untuk mahasiswa</a>
                    <!-- end mahasiswa -->
                </div>
                <!-- /.box-header -->
                            ...
                            foreach ($tampil as $row) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= base_url('pengajuan_mhs/detail/') . encrypt_url($row['id_pinjam']); ?>" class="btn btn-info btn-sm"> <i class="fa fa-eye"></i> </a>

                                        <!-- end detail superadmin -->

                                        <!-- print superadmin -->
                                        <?php if ($row['status'] == 1) : ?>
                                            <a href="<?= base_url('pengajuan_mhs/cetak_laporan/') . encrypt_url($row['id_pinjam']); ?>" class="btn btn-primary btn-sm" target="_blank"> <i class="fa fa-print"></i></a>
                                        <?php endif; ?>
                                        <!-- end print superadmin -->

                                        <a href="<?= base_url('pengajuan_mhs/batal/') . encrypt_url($row['id_pinjam']); ?>" <?php if ($row['status'] == 1 || $row['status'] == 2) { ?> echo style="display: none;" <?php } ?> class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin?');"> <i class="fa fa-close"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
...
<script>
    ...
    function load_data() {
        $("#tabel3").DataTable({
            ...
            "ajax": {
                "url": "<?= base_url('pengajuan_mhs/get_datamhs') ?>",
                "type": "POST"
            },
