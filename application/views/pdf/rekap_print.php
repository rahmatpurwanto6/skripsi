...
<body>
    ...
    <table border="0" width="680px">
        <tr>
            <td style="font-family: Arial, Helvetica, sans-serif; font-size: 11pt;">&nbsp;&nbsp;&nbsp;Menyetujui,</td>
            <td style="font-family: Arial, Helvetica, sans-serif; font-size: 11pt;" class="text-center">Pemohon</td>
        </tr>
        <tr>
            <td><img src="<?= base_url('assets/qrcode_img/Syifa Nur Fauziah.png') ?>" style="width: 100px;"></td>
            <td width="25%"></td>
        </tr>
        <tr>
            <td>(Bag. Akademik)</td>
