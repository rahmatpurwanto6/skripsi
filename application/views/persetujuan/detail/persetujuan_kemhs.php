        ...
        <div class="col-md-6">
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <form action="<?= base_url('persetujuan_kemhs/approve') ?>" method="post">
                        <?php foreach ($tampil as $row) : ?>
                            <input type="hidden" name="id" class="form-control" value="<?= $row['id_pinjam']; ?>">

                            <div class="form-group">
                                <label for="">NIM</label>
                                <select name="id2" id="id2" class="form-control" value="<?= $row['username']; ?>" readonly>
                ...
                <div class="box-footer clearfix">
                    ...
                    <a href="<?= base_url('persetujuan_kemhs'); ?>" class="btn btn-default">Kembali</a>
                </div>
                </form>
            </div>
        </div>
