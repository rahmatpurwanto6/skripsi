                            ...
                            foreach ($tampil as $row) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <!-- <a href="<?= base_url('persetujuan_admin1/detail_ormawa/') . encrypt_url($row['id_pinjam']); ?>" class="btn btn-primary btn-sm"> <i class="fa fa-eye"></i> </a> -->

                                        <a href="<?= base_url('persetujuan_admin1/detail_persetujuan/') . encrypt_url($row['id_pinjam']); ?>" class="btn btn-info btn-sm"> <i class="fa fa-eye"></i> </a>
...
<script>
    ...
    function load_data() {
        $("#tabel1").DataTable({
            ...
            "ajax": {
                "url": "<?= base_url('persetujuan_admin1/get_persetujuanadmin1') ?>",
                "type": "POST"
            },
