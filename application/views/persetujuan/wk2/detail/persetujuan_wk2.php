        ...
        <div class="col-md-6">
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <form action="<?= base_url('approve_wk2/simpanpersetujuan') ?>" method="post">
                        <?php foreach ($tampil as $row) : ?>
                            ...
                            <div class="form-group">
                                <label>Penganjuan</label>
                                <input type="text" name="pengajuan" id="pengajuan" class="form-control" autocomplete="off" value="<?= $row['tgl_pengajuan'] ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label>Dari</label>
                            ...
                            <div class="form-group">
                                <label>Mulai</label>
                                <input type="time" name="mulai" id="mulai" class="form-control timepicker" value="<?= $row['mulai']; ?>" readonly>
                                <!-- /.input group -->
                            </div>
                            <!-- /.form group -->
                            ...
                            <div class="form-group">
                                <label>Selesai</label>
                                <input type="time" name="selesai" id="selesai" class="form-control timepicker" value="<?= $row['selesai']; ?>" readonly>
                                <!-- /.form group -->
                            </div>
                ...
                <div class="box-footer clearfix">
                    ...
                    <a href="<?= base_url('approve_wk2'); ?>" class="btn btn-default">Kembali</a>
                </div>
                </form>
            </div>
        </div>
