                            ...
                            foreach ($tampil as $row) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= base_url('approve_wk2/detail/') . encrypt_url($row['id_pinjam']); ?>" class="btn btn-info btn-sm"> <i class="fa fa-eye"></i> </a>
...
<script>
    ...
    function load_data() {
        $("#tabel1").DataTable({
            ...
            "ajax": {
                "url": "<?= base_url('approve_wk2/get_persetujuan_wk2') ?>",
                "type": "POST"
            },
